...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        CTRL_ESC, KC_LALT, _______, LOWER,  KC_SPC, KC_SPC, RAISE,  RAISE,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT),
    ...
    [_ADJUST] = LAYOUT(
        ...
        LOCK,    _______, _______, _______, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY)};
